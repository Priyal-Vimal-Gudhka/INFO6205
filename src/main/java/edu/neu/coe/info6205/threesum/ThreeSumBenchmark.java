...
//        if (description.equals("ThreeSumCubic") && n > 4000) return;
        ...
        {
            System.out.println("Raw Time for "+description+ " alogirithm is : "+timeTaken);
            System.out.println("Normalized Time for "+description+ " algorithm is : " + (timeTaken/n/n/Utilities.lg(n)*1e6));
        }

        else if(description.equals("ThreeSumCubic"))
        {
            System.out.println("Raw Time for "+description+ " alogirithm is : "+timeTaken);
            System.out.println("Normalized Time for "+description+ " algorithm is : " + (timeTaken/n/n/n*1e6));
        }
        else
        {
            System.out.println("Raw Time for "+description+ " alogirithm is : "+timeTaken);
            System.out.println("Normalized Time for "+description+ " algorithm is : " + (timeTaken/n/n*1e6));
        }
        // END
    }
